...
class WPEX_Welcome {
	...
	public function recommended_screen() { ?>
		...
		<div class="wrap about-wrap">
			...
			<h1>Elegant Theme v<?php echo esc_html( $theme_version ); ?></h1>

			<div class="about-text" style="margin-bottom:40px;min-height:0;"><?php esc_html_e( 'A free WordPress theme by WPExplorer.com', 'elegant' ); ?></div>

			<div style="padding-bottom:100px;">

				<h2><?php esc_html_e( 'About', 'elegant' ); ?></h2>
				<hr />
				...
				<div>
					...
					<p>
					<?php esc_html_e( 'This theme was created by WPExplorer.com.', 'elegant' ); ?>
					<br />
					<?php esc_html_e( 'We work hard to develop and update this theme.', 'elegant' ); ?>
					<br />
				...
				<div>
					<h4><?php esc_html_e( 'Liability', 'elegant' ); ?></h4>
					<p>
					<?php esc_html_e( 'WPExplorer.com shall not be held liable for any damages, including, but not limited to, the loss of data or profit, arising from the use of, or inability to use, this theme.', 'elegant' ); ?>
					</p>
				</div>

				<br /><br />

				<h2><?php esc_html_e( 'Getting Started', 'elegant' ); ?></h2>
				...
				<div>
					...
					<a href="http://www.wpexplorer.com/elegant-free-wordpress-theme/" target="_blank" class="button button-primary"><?php esc_html_e( 'Theme Page', 'elegant' ); ?></a>
				</div>

				<br /><br />

				<h2><?php esc_html_e( 'Recommendations', 'elegant' ); ?></h2>
