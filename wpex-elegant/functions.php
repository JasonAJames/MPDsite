...
class WPEX_Theme_Class {
	...
	public function constants() {
		...
		define( 'WPEX_INCLUDES_DIR', $this->template_dir .'/inc/' );
	...
	public function premium() {
		...
		$files = glob( $this->template_dir .'/premium/*.php' );
	...
	public function setup() {
		...
		load_theme_textdomain( 'elegant', $this->template_dir .'/languages' );
