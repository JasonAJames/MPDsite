...
if (file_exists(JPATH_BASE. '/components/com_joomfish/joomfish.php'))
	{
		@rename( JPATH_BASE."/components/com_xtremelocator/xtremelocator_config.xml", JPATH_BASE."/components/com_joomfish/contentelements/xtremelocator_config.xml"); 
		@rename( JPATH_BASE."/components/com_xtremelocator/xtremelocator_fields.xml", JPATH_BASE."/components/com_joomfish/contentelements/xtremelocator_fields.xml"); 
	} 
