...
<table class="adminform">    
   ...
   <tr>
    ...
    <table class="adminlist">
                <thead>
                    <tr>                        
                        <th><a href="index2.php?option=com_xtremelocator&amp;task=list_locations&amp;t=1&amp;sort_by=field_name"   ><?php echo JText::_('FIELD');?></a></th>
                        <th><?php echo JText::_('ENABLED');?></th>
                        <th><a href="index2.php?option=com_xtremelocator&amp;task=list_locations&amp;t=1&amp;sort_by=field_id"   ><?php echo JText::_('ID');?></a></th>
                    ...
                    <tr>
                        ...
                        <td><strong><a href="index2.php?option=com_xtremelocator&amp;task=list_locations&amp;t=1&amp;sort_by=order"   ><?php echo JText::_('ORDER');?></a></strong></td>
                        <td><strong><?php echo JText::_('VISIBLE');?></strong></td>
                        <td><strong><?php echo JText::_('SHOW TITLE');?></strong></td>
                        <td><strong><a href="index2.php?option=com_xtremelocator&amp;task=list_locations&amp;t=2&amp;sort_by=order"   ><?php echo JText::_('ORDER');?></a></strong></td>                     
                    </tr>
                </thead>
                <tfoot>
                     <tr>
                ...
                <tbody>
                  ...
                  foreach ($afields as $i=>$ff){?>
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="visible[1_4_<?php echo $afields[$i]->id;?>]" value="1" <?php echo $cfl->visible==1?'checked="checked"':"";?>/>
                       </td>
                        <td><input type="checkbox" name="title[1_4_<?php echo $afields[$i]->id;?>]" value="1" <?php echo $cfl->show_title==1?'checked="checked"':"";?>/></td>
                        <td><input type="text" name="order[1_4_<?php echo $afields[$i]->id;?>]" value="<?php echo $cfl->order;?>" /></td>
                         <td><input type="checkbox" name="visible[2_4_<?php echo $afields[$i]->id;?>]" value="1" <?php echo $cfd->visible==1?'checked="checked"':"";?>/>
                       </td>
                        <td><input type="checkbox" name="title[2_4_<?php echo $afields[$i]->id;?>]" value="1" <?php echo $cfd->show_title==1?'checked="checked"':"";?>/></td>
                        <td><input type="text" name="order[2_4_<?php echo $afields[$i]->id;?>]" value="<?php echo $cfd->order;?>" /></td>                     
                    </tr>
                   <?php }?>
...
<input type="hidden" name="task" value="list_locations" />
