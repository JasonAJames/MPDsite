...
<form action="<?php echo JRoute::_( 'index.php?option=com_simplesubscribe' ); ?>" method="post" id="josForm" name="josForm" class="form-validate">
...
<tr>
	...
	<button class="button validate" type="submit"><?php echo JText::_('Subscribe'); ?></button>
