...
<title>MyPrintingDeals.com - Envelope Printing</title>
...
<body><div id="content">
  <form action="/gdform.php" method="post" name="CustomPrintQuote" id="CustomPrintQuote" onsubmit="MM_validateForm('007productDeliveryZip','','RisNum','_001custFirstName','','R','_002custLastName','','R','_003custEmail','','RisEmail','_004custAddress1','','R','_006custCity','','R','_007custState','','R','_008custZip','','RisNum');return document.MM_returnValue">
      <span class="HEADER2">Envelopes
        <input name="000Interested_in" type="hidden" id="Interested_in" value="Envelope Quote." />
      </span><br />
      <br />
      <fieldset id="PrintOptions">
      <span class="HEADER3"><u><br />
        Print Options</u></span> <br />
  <input type="hidden" name="subject" value="Envelope Printing Quote Form Submission" />
  ...
  <table border="0" cellpadding="1" cellspacing="1" id="PrintOptionsTable">
    <tr>
      ...
      <td width="228" align="left" valign="bottom"><select name="001productStock" id="001productStock">
        <option value="24lb. Premium Smooth Writing" selected="selected">24lb. Premium Smooth Writing</option>
        <option value="24lb. Premium Linen Bright White">24lb. Premium Linen Bright White</option>
        <option value="60lb. Standard Opaque Smooth">60lb. Standard Opaque Smooth</option>
        <option value="A-2 24lb. Envelope">A-2 24lb. Envelope</option>
        <option value="A-2 70lb. Premium Envelope">A-2 70lb. Premium Envelope</option>
        <option value="A-6 24lb. Envelope">A-6 24lb. Envelope</option>
        <option value="A-6 70lb. Premium Envelope">A-6 70lb. Premium Envelope</option>
        <option value="A-7 24lb. Envelope">A-7 24lb. Envelope</option>
        <option value="A-7 70lb. Premium Envelope">A-7 70lb. Premium Envelope</option>
        <option value="A-9 24lb. Envelope">A-9 24lb. Envelope</option>
        <option value="A-9 70lb. Premium Envelope">A-9 70lb. Premium Envelope</option>
        <option value="#10 Window 24lb. White Wove  ">#10 Window 24lb. White Wove </option>
        <option value="#9 Regular 24lb. White Wove">#9 Regular 24lb. White Wove</option>
        <option value="#10 24lb. Premium Smooth">#10 24lb. Premium Smooth</option>
        <option value="#10 24lb. Premium Linen">#10 24lb. Premium Linen</option>
        <option value="#10 Regular 24lb. White Wove">#10 Regular 24lb. White Wove</option>
        <option value="6 x 9 24lb. White Wove Catalog Envelope">6&quot; x 9&quot; - 24lb. White Wove Catalog Envelope</option>
        <option value="6 x 9 24lb. White Wove Booklet Envelope">6&quot; x 9&quot; - 24lb. White Wove Booklet Envelope</option>
        <option value="9 x 12 24lb. White Wove Catalog Envelope">9&quot; x 12&quot; - 24lb. White Wove Catalog Envelope</option>
        <option value="9 x 12 24lb. White Wove Booklet Envelope">9&quot; x 12&quot; - 24lb. White Wove Booklet Envelope</option>
        <option value="10 x 13 28lb. White Wove Catalog Envelope">10&quot; x 13&quot; - 28lb. White Wove Catalog Envelope</option>
        <option value="10 x 13 28lb. White Wove Booklet Envelope">10&quot; x 13&quot; - 28lb. White Wove Booklet Envelope</option>
      </select></td>
    </tr>
    <tr>
      ...
      <td align="left" valign="bottom"><select name="002productSize" id="002productSize">
        <option value="#9 Regular 8.875 3.875" selected="selected">#9 Regular 8.875&quot; 3.875&quot;</option>
        <option value="#10 Regular 9.5 x 4.125">#10 Regular 9.5&quot; x 4.125&quot;</option>
        <option value="#10 Regular 9.5 x 4.125">#10 Regular 9.5&quot; x 4.125&quot;</option>
        <option value="#10 Window 9.5 x 4.125">#10 Window 9.5&quot; x 4.125&quot;</option>
        <option value="A-2 Envelope 5.75 x 4.5">A-2 Envelope 5.75&quot; x 4.5&quot;</option>
        <option value="A-6 Envelope 6.5 x 4.75">A-6 Envelope 6.5&quot; x 4.75&quot;</option>
        <option value="A-7 Envelope 7.25 x 5.25">A-7 Envelope 7.25&quot; x 5.25&quot;</option>
        <option value="A-9 Envelope 8.75 x 5.875">A-9 Envelope 8.75&quot; x 5.875&quot;</option>
    ...
    <tr>
      ...
      <td align="left" valign="bottom"><select name="003productSpecs" id="003productSpecs">
        <option value="4/0 - Full Color Front / Blank Back" selected="selected">4/0 - Full Color Front / Blank Back</option>
        <option value="1/0 Black Only">1/0 Black Only</option>
        <option value="1/0 1 PMS Color">1/0 1 PMS Color</option>
        <option value="2/0 Black + 1 PMS">2/0 Black + 1 PMS</option>
        <option value="2/0 2 PMS Colors">2/0 2 PMS Colors</option>
    ...
    <tr>
      ...
      <td align="left" valign="bottom"><select name="005turnaroundTime" id="005turnaroundTime">
        <option value="Standard 3-5 Days" selected="selected">Standard 3-5 Days</option>
        <option value="Express 2 Day">Express 2 Day</option>
        <option value="Wait and Save 5-10 Days">Wait and Save 5-10 Days</option>
      </select></td>
    </tr>
    <tr>
