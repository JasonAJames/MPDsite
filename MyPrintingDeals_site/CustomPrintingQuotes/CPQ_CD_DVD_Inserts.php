...
<title>MyPrintingDeals.com - CD and DVD Inserts Printing</title>
...
<body><div id="content">
  <form action="/gdform.php" method="post" name="CustomPrintQuote" id="CustomPrintQuote" onsubmit="MM_validateForm('007productDeliveryZip','','RisNum','_001custFirstName','','R','_002custLastName','','R','_003custEmail','','RisEmail','_004custAddress1','','R','_006custCity','','R','_007custState','','R','_008custZip','','RisNum');return document.MM_returnValue">
      <span class="HEADER2">CD and DVD Inserts 
        <input name="000Interested_in" type="hidden" id="Interested_in" value="CD and DVD Inserts Quote." />
      </span><br />
      <br />
      <fieldset id="PrintOptions">
      <span class="HEADER3"><u><br />
        Print Options</u></span> <br />
  <input type="hidden" name="subject" value="CD and DVD Inserts Printing Quote Form Submission" />
  ...
  <table border="0" cellpadding="1" cellspacing="1" id="PrintOptionsTable">
    <tr>
      ...
      <td width="228" align="left" valign="bottom"><select name="001productStock" id="001productStock">
        <option value="100lb. Gloss Book" selected="selected">100lb. Gloss Book</option>
      </select></td>
    </tr>
    <tr>
      ...
      <td align="left" valign="bottom"><select name="002productSize" id="002productSize">
        <option value="4.75 x 4.75" selected="selected">4.75&quot; x 4.75&quot;</option>
        <option value="4.75 x 9.5">4.75&quot; x 9.5&quot;</option>
        <option value="4.75 x 14.25">4.75&quot; x 14.25&quot;</option>
        <option value="4.75 x 19">4.75&quot; x 19&quot;</option>
        <option value="5.9375 x 4.625">5.9375&quot; x 4.625&quot;</option>
        <option value="7.25 x 10.75">7.25&quot; x 10.75&quot;</option>
      </select></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="bottom"><select name="005turnaroundTime" id="005turnaroundTime">
        <option value="Standard 2-4 Days" selected="selected">Standard 2-4 Days</option>
