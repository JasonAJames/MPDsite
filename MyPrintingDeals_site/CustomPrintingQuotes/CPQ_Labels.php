...
<title>MyPrintingDeals.com - Sticker and Label Printing</title>
...
<body><div id="content"> 
  <form action="/gdform.php" method="post" name="CustomPrintQuote" id="CustomPrintQuote" onsubmit="MM_validateForm('007productDeliveryZip','','RisNum','_001custFirstName','','R','_002custLastName','','R','_003custEmail','','RisEmail','_004custAddress1','','R','_006custCity','','R','_007custState','','R','_008custZip','','RisNum');return document.MM_returnValue">
    <span class="HEADER2">Roll Labels 
      <input name="000Interested_in" type="hidden" id="Interested_in" value="Sticker and Label Quote." />
  </span><br />
    <br />
  <fieldset id="PrintOptions">
    ...
    <br />
    <input type="hidden" name="subject" value="Roll Label Printing Quote Form Submission" />
    ...
    <table border="0" cellpadding="1" cellspacing="1" id="PrintOptionsTable">
      <tr>
        ...
        <td width="228" align="left" valign="bottom"><select name="001productStock" id="001productStock">
          <option value="60lb. Adhesive Back Roll Labels" selected="selected">60lb. Adhesive Back Roll Labels</option>
          </select></td>
        </tr>
      <tr>
        ...
        <td align="left" valign="bottom"><select name="002productSize" id="002productSize">
          <option value="2 x 4" selected="selected">2&quot; x 4&quot;</option>
          ...
          <option value="4.25 x 2.75">4.25&quot; x 2.75&quot;</option>
          <option value="4.25 x 3.66">4.25&quot; x 3.66&quot;</option>
          ...
          <option value="8.5 x 2.75">8.5&quot; x 2.75&quot;</option>
          <option value="8.5 x 3.66">8.5&quot; x 3.66&quot;</option>
