...
<title>MyPrintingDeals.com - Catalog Printing</title>
...
<body><div id="content">
  <form action="/gdform.php" method="post" name="CustomPrintQuote" id="CustomPrintQuote" onsubmit="MM_validateForm('007productDeliveryZip','','RisNum','_001custFirstName','','R','_002custLastName','','R','_003custEmail','','RisEmail','_004custAddress1','','R','_006custCity','','R','_007custState','','R','_008custZip','','RisNum');return document.MM_returnValue">
      <span class="HEADER2">Catalogs
        <input name="000Interested_in" type="hidden" id="Interested_in" value="Catalog Quote." />
      </span><br />
      <br />
      <fieldset id="PrintOptions">
      <span class="HEADER3"><u><br />
        Print Options</u></span> <br />
  <input type="hidden" name="subject" value="Catalog Printing Quote Form Submission" />
  ...
  <table border="0" cellpadding="1" cellspacing="1" id="PrintOptionsTable">
    <tr>
      ...
      <td width="228" align="left" valign="bottom"><select name="001productStock" id="001productStock">
        <option value="80lb. Gloss Book" selected="selected">80lb. Gloss Book</option>
    ...
    <tr>
      ...
      <td align="left" valign="bottom"><select name="002productSize" id="002productSize">
        <option value="8.5 x 11 - 8 Pages" selected="selected">8.5&quot; x 11&quot; - 8 Pages</option>
        <option value="8.5 x 11 - 12 Pages">8.5&quot; x 11&quot; - 12 Pages</option>
        <option value="8.5 x 11 - 16 Pages">8.5&quot; x 11&quot; - 16 Pages</option>
        <option value="8.5 x 11 - 20 Pages">8.5&quot; x 11&quot; - 20 Pages</option>
        <option value="8.5 x 11 - 24 Pages">8.5&quot; x 11&quot; - 24 Pages</option>
        <option value="8.5 x 11 - 32 Pages">8.5&quot; x 11&quot; - 32 Pages</option>
      </select></td>
    </tr>
    <tr>
