...
<title>MyPrintingDeals.com - Brochure Printing</title>
...
<body><div id="content">
  <form action="/gdform.php" method="post" name="CustomPrintQuote" id="CustomPrintQuote" onsubmit="MM_validateForm('007productDeliveryZip','','RisNum','_001custFirstName','','R','_002custLastName','','R','_003custEmail','','RisEmail','_004custAddress1','','R','_006custCity','','R','_007custState','','R','_008custZip','','RisNum');return document.MM_returnValue">
    <span class="HEADER2">Brochures
      <input name="000Interested_in" type="hidden" id="Interested_in" value="Brochures Quote." />
      </span><br />
    <br />
    <fieldset id="PrintOptions">
      <span class="HEADER3"><u><br />
        Print Options</u></span> <br />
      <input type="hidden" name="subject" value="Brochure Printing Quote Form Submission" />
      <input type="hidden" name="redirect" value="/IE/Imaging/Pages/Printing/SubmissionGuideline_Pages/PrintingSubmission_ThankyouPage.html" />
      <br />
      <table border="0" cellpadding="1" cellspacing="1" id="PrintOptionsTable">
        ...
        <tr>
          ...
          <td align="left" valign="bottom"><select name="005turnaroundTime" id="005turnaroundTime">
            ...
            <option value="Wait and Save 5-7 Days">Wait and Save 5-7 Days</option>
        ...
        <tr>
          <td height="28" colspan="2" align="left" valign="bottom"><label for="SandHmethod">Preffered Shipping and Handling Method:</label></td>
          </tr>
        <tr>
