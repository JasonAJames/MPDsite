...
<title>MyPrintingDeals.com - Announcement Envelope Printing</title>
...
<body>
<div id="content">
  <form action="/formMailer.php" method="post" name="CustomPrintQuote" id="CustomPrintQuote" onsubmit="MM_validateForm('007productDeliveryZip','','RisNum','_001custFirstName','','R','_002custLastName','','R','_003custEmail','','RisEmail','_004custAddress1','','R','_006custCity','','R','_007custState','','R','_008custZip','','RisNum');return document.MM_returnValue">
      <input type="hidden" name="check_submit" value="1" />
    <span class="HEADER2">Announcement Envelopes
      <input name="000Interested_in" type="hidden" id="Interested_in" value="Announcement Envelope Quote" />
      </span><br />
    <br />
    <fieldset id="PrintOptions">
      <span class="HEADER3"><u><br />
        Print Options</u></span> <br />
      <input type="hidden" name="subject" value="Announcement Envelope Printing Quote Form Submission" />
      <input type="hidden" name="redirect" value="/PrintingSubmission_ThankyouPage.html" />
      <br />
      <table border="0" cellpadding="1" cellspacing="1" id="PrintOptionsTable">
        <tr>
          <td width="186" align="right" valign="bottom"><label for="ProductStock"> Product Stock:</label></td>
          <td width="308" align="left" valign="bottom"><select name="001productStock" id="001productStock">
            <option value="A-2 24lb. Envelope" selected="selected">A-2 24lb. Envelope</option>
        ...
        <tr>
          ...
          <td align="left" valign="bottom"><select name="002productSize" id="002productSize">
            <option value="A-2 Envelope 5.75 x 4.5" selected="selected">A-2 Envelope 5.75&quot; x 4.5&quot;</option>
        ...
        <tr>
          ...
          <td align="left" valign="bottom"><select name="003productSpecs" id="003productSpecs">
            <option value="1/0 Black Only" selected="selected">1/0 Black Only</option>
