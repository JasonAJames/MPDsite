...
<title>MyPrintingDeals.com - Screen Printing</title>
...
<body><div id="content">
  <form action="/gdform.php" method="post" name="CustomPrintQuote" id="CustomPrintQuote" onsubmit="MM_validateForm('008productDeliveryZip','','RisNum','_001custFirstName','','R','_002custLastName','','R','_003custEmail','','RisEmail','_004custAddress1','','R','_006custCity','','R','_007custState','','R','_008custZip','','RisNum');return document.MM_returnValue">
    <span class="HEADER2">Screen Printing 
      <input name="000Interested_in" type="hidden" id="Interested_in" value="Screen Printing Quote." />
      </span><br />
    <br />
    <fieldset id="PrintOptions">
      <span class="HEADER3"><u><br />
        Print Options</u></span> <br />
      <input type="hidden" name="subject" value="Screen Printing Quote Form Submission" />
      ...
      <table border="0" cellpadding="1" cellspacing="1" id="PrintOptionsTable">
        <tr>
          ...
          <td width="237" align="left" valign="bottom"><select name="001productStock" id="001productStock">
            <option value="CD / DVD" selected="selected">CD / DVD</option>
            <option value="Sweatshirts">Sweatshirts</option>
            <option value="Short Sleeve T-Shirts">T-Shirts (Short Sleeve)</option>
            <option value="Long Sleeve T-Shirts">T-Shirts (Long Sleeve)</option>
        ...
        <tr>
          <td align="right" valign="top"><label for="select">Other (Specify Here):</label></td>
          <td align="left" valign="bottom"><textarea name="004productOther_SpecifiedHere" id="004productOther_SpecifiedHere"></textarea></td>
          </tr>
        <tr>
          <td align="right" valign="bottom"><label for="ProductQuantity">Product Quantity:</label></td>
          <td align="left" valign="bottom"><select name="005productQuantity" id="005productQuantity">
        ...
        <tr>
          <td align="right" valign="top"><label for="ProductQuantity">Screen Printing Colors:</label></td>
          <td align="left" valign="bottom"><select name="005a_print_Color_1" id="005a_print_Color_1">
            <option value="NoColorSelected" selected="selected">Select Color</option>
            ...
            <option value="OTHER_SpecifiedBelow">Other</option>
            </select>
            <span class="smallText"><br />
              Other (Specify Here):
              <input name="005a_print_Color_1_Other" type="text" size="12" />
            </span></td>
          </tr>
        <tr>
          <td align="right" valign="bottom">&nbsp;</td>
          <td align="left" valign="bottom"><select name="005a_print_Color_2" id="005a_print_Color_2">
            <option value="NoColorSelected" selected="selected">Select Color</option>
            <option value="BLACK">Black</option>
            <option value="BLUE">Blue</option>
            <option value="GREEN">Green</option>
        ...
        <tr>
          <td align="right" valign="bottom">&nbsp;</td>
          <td align="left" valign="bottom"><select name="005a_print_Color_3" id="005a_print_Color_3">
            <option value="NoColorSelected" selected="selected">Select Color</option>
            <option value="BLACK">Black</option>
            <option value="BLUE">Blue</option>
            <option value="GREEN">Green</option>
        ...
        <tr>
          ...
          <td align="left" valign="bottom"><select name="006turnaroundTime" id="006turnaroundTime">
            <option value="Standard 15-20 Days" selected="selected">Standard 15-20 Days</option>
            <option value="Wait and Save 20-30 Days">Wait and Save 20-30 Days</option>
            </select></td>
          </tr>
        <tr>
        ...
        <tr>
          <td align="left" valign="bottom">&nbsp;</td>
          <td align="left" valign="bottom"><select name="007productS_Hmethod" id="007productS_Hmethod">
        ...
        <tr>
          ...
          <td align="left" valign="bottom"><input name="008productDeliveryZip" type="text" id="008productDeliveryZip" size="12" maxlength="12" /></td>
          </tr>
        </table>
      <br />
      </fieldset>
