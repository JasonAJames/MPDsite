...
<title>MyPrintingDeals.com - Bookmark Printing</title>
...
<body><div id="content">
  <form action="/gdform.php" method="post" name="CustomPrintQuote" id="CustomPrintQuote" onsubmit="MM_validateForm('007productDeliveryZip','','RisNum','_001custFirstName','','R','_002custLastName','','R','_003custEmail','','RisEmail','_004custAddress1','','R','_006custCity','','R','_007custState','','R','_008custZip','','RisNum');return document.MM_returnValue">
    <span class="HEADER2">Bookmarks
      <input name="000Interested_in" type="hidden" id="Interested_in" value="Bookmarks Quote." />
      </span><br />
    <br />
    <fieldset id="PrintOptions">
      <span class="HEADER3"><u><br />
        Print Options</u></span> <br />
      <input type="hidden" name="subject" value="Bookmarks Printing Quote Form Submission" />
      ...
      <table border="0" cellpadding="1" cellspacing="1" id="PrintOptionsTable">
        <tr>
          ...
          <td width="228" align="left" valign="bottom"><select name="001productStock" id="001productStock">
            <option value="14pt. CS1">14pt. CS1</option>
            <option value="14pt. CS2">14pt. CS2</option>
            </select></td>
          </tr>
        <tr>
          ...
          <td align="left" valign="bottom"><select name="002productSize" id="002productSize">
            <option value="1.5 x 7" selected="selected">1.5&quot; x 7&quot;</option>
            <option value="2 x 8">2&quot; x 8&quot;</option>
            <option value="5.5 x 2.125">5.5&quot; x 2.125&quot;</option>
            </select></td>
          </tr>
        <tr>
        ...
        <tr>
          <td align="right" valign="bottom"><label for="select">Turnaround Time:</label></td>
        ...
        <tr>
          <td colspan="2" align="left" valign="bottom" class="HEADER3">&nbsp;</td>
          </tr>
        <tr>
