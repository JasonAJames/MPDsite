...
<title>MyPrintingDeals.com - Metalics Printing</title>
...
<body><div id="content">
  <form action="/gdform.php" method="post" name="CustomPrintQuote" id="CustomPrintQuote" onsubmit="MM_validateForm('007productDeliveryZip','','RisNum','_001custFirstName','','R','_002custLastName','','R','_003custEmail','','RisEmail','_004custAddress1','','R','_006custCity','','R','_007custState','','R','_008custZip','','RisNum');return document.MM_returnValue">
    <span class="HEADER2">Metalics 
      <input name="000Interested_in" type="hidden" id="Interested_in" value="Metalics Quote." />
      </span><br />
    <br />
    <fieldset id="PrintOptions">
      <span class="HEADER3"><u><br />
        Print Options</u></span> <br />
      <input type="hidden" name="subject" value="Metalics Printing Quote Form Submission" />
      ...
      <table border="0" cellpadding="1" cellspacing="1" id="PrintOptionsTable">
        ...
        <tr>
          ...
          <td align="left" valign="bottom"><select name="003productSpecs" id="003productSpecs">
            <option value="4/0 + Metalic Silver Front Side" selected="selected">4/0 + Metalic Silver Front Side</option>
            <option value="4/0 + Metalic Gold Front Side">4/0 + Metalic Gold Front Side</option>
            <option value="4/1 + Metalic Silver Both Sides">4/1 + Metalic Silver Both Sides</option>
            <option value="4/1 + Metalic Silver Front Side">4/1 + Metalic Silver Front Side</option>
            <option value="4/1 + Metalic Gold Both Sides">4/1 + Metalic Gold Both Sides</option>
            <option value="4/1 + Metalic Gold Front Side">4/1 + Metalic Gold Front Side</option>
            <option value="4/4 + Metalic Silver Both Sides">4/4 + Metalic Silver Both Sides</option>
            <option value="4/4 + Metalic Silver Front Side">4/4 + Metalic Silver Front Side</option>
            <option value="4/4 + Metalic Gold Both Sides">4/4 + Metalic Gold Both Sides</option>
            <option value="4/4 + Metalic Gold Front Side">4/4 + Metalic Gold Front Side</option>
            </select></td>
          </tr>
        <tr>
