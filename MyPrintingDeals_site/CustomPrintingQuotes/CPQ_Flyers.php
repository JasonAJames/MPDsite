...
<title>MyPrintingDeals.com - Flyer Printing</title>
...
<body><div id="content">
  <form action="/gdform.php" method="post" name="CustomPrintQuote" id="CustomPrintQuote" onsubmit="MM_validateForm('007productDeliveryZip','','RisNum','_001custFirstName','','R','_002custLastName','','R','_003custEmail','','RisEmail','_004custAddress1','','R','_006custCity','','R','_007custState','','R','_008custZip','','RisNum');return document.MM_returnValue">
      <span class="HEADER2">Flyers
        <input name="000Interested_in" type="hidden" id="Interested_in" value="Flyer Quote." />
      </span><br />
      <br />
      <fieldset id="PrintOptions">
      <span class="HEADER3"><u><br />
        Print Options</u></span> <br />
  <input type="hidden" name="subject" value="Flyer Printing Quote Form Submission" />
  ...
  <table border="0" cellpadding="1" cellspacing="1" id="PrintOptionsTable">
    <tr>
      ...
      <td width="228" align="left" valign="bottom"><select name="001productStock" id="001productStock">
        <option value="60lb. Standard Opaque Smooth" selected="selected">60lb. Standard Opaque Smooth</option>
        <option value="70lb. Standard Opaque Smooth">70lb. Standard Opaque Smooth</option>
        <option value="70lb. RECYCLED Opaque Smooth">70lb. RECYCLED Opaque Smooth</option>
        <option value="80lb. Gloss Book">80lb. Gloss Book</option>
        <option value="100lb. Gloss Book">100lb. Gloss Book</option>
        <option value="100lb. RECYCLED Gloss Book">100lb. RECYCLED Gloss Book</option>
        <option value="100lb. Matte Book">100lb. Matte Book</option>
        <option value="80lb. Gloss Cover">80lb. Gloss Cover</option>
        <option value="100lb. Gloss Cover">100lb. Gloss Cover</option>
        <option value="100lb. RECYCLED Gloss Cover">100lb. RECYCLED Gloss Cover</option>
        <option value="12pt. Matte #1 Premium Sheet">12pt. Matte #1 Premium Sheet</option>
    ...
    <tr>
      ...
      <td align="left" valign="bottom"><select name="002productSize" id="002productSize">
        <option value="3.5 x 8.5" selected="selected">3.5&quot; x 8.5&quot;</option>
        ...
        <option value="25.5 x 11">25.5&quot; x 11&quot;</option>
      </select></td>
    </tr>
    <tr>
      ...
      <td align="left" valign="bottom"><select name="003productSpecs" id="003productSpecs">
        ...
        <option value="4/1 - Full Color Front / Black Back">4/1 - Full Color Front / Black Back</option>
