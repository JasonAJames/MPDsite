...
<title>MyPrintingDeals.com - Business Card Printing</title>
...
<body><div id="content"><form action="/gdform.php" method="post" name="CustomPrintQuote" id="CustomPrintQuote" onsubmit="MM_validateForm('007productDeliveryZip','','RisNum','_001custFirstName','','R','_002custLastName','','R','_003custEmail','','RisEmail','_004custAddress1','','R','_006custCity','','R','_007custState','','R','_008custZip','','RisNum');return document.MM_returnValue">
    <span class="HEADER2">Business Cards
      <input name="000Interested_in" type="hidden" id="Interested_in" value="Business Cards Quote." />
  </span><br />
    <br />
  <fieldset id="PrintOptions">
    <span class="HEADER3"><u><br />
      Print Options</u></span>
    <br />
    <input type="hidden" name="subject" value="Business Card Printing Quote Form Submission" />
    <input type="hidden" name="redirect" value="/websites/MyPrintingDeals/Printing/SubmissionGuideline_Pages/PrintingSubmission_ThankyouPage.html" />
    <br />
    <table border="0" cellpadding="1" cellspacing="1" id="PrintOptionsTable">
      <tr>
        ...
        <td width="228" align="left" valign="bottom"><select name="001productStock" id="001productStock">
          ...
          <option value="16pt. C2S">16pt. C2S</option>
          </select></td>
        </tr>
      <tr>
        ...
        <td align="left" valign="bottom"><select name="002productSize" id="002productSize">
          <option value="3.5 x 2" selected="selected">3.5&quot; x 2&quot;</option>
          <option value="3.5 x 4">3.5&quot; x 4&quot;</option>
